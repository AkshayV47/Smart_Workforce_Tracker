...
// USER Email - vakshayofficial@gmail.com

#define BLYNK_TEMPLATE_ID "TMPL3e9E9LHvm"
#define BLYNK_TEMPLATE_NAME "Workforce Tracking"
...
static const int RXPin = 4, TXPin = 5;   // GPIO 4=D2(conneect Rx of GPS) and GPIO 5=D1(Connect Tx of GPS)
...
char auth[] = "wZ5wKKsfYBKGfEh5pYW3k6awRW24ozbo";            //Blynk Authentication Token
char ssid[] = "OPPOReno8T5G";            // WiFi SSID
char pass[] = "OPPO8T5G";            // WiFi Password
